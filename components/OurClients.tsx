...
export function OurClients() {
  return (
    <div className="h-[20rem] rounded-md flex flex-col antialiased bg-white dark:white dark:bg-grid-white/[0.05] items-center justify-center relative overflow-hidden">
      <InfiniteMovingCards
        items={testimonials}
        direction="right"
        speed="slow"
