...
//       ref={cardRef}
//       className={cn(
//         "bg-[#1d1c20] border border-white/[0.08] w-full h-full text-center rounded-lg p-8 relative overflow-hidden",
//         className
//       )}
//     >
//       {children}

//       <div className="h-40 relative flex flex-col items-center overflow-hidden text-center">
//         <motion.div
//           style={{
//             width: "100%",
//           }}
...
//     <p
//       className={twMerge(
//         "text-[#a9a9a9] items-center text-center text-sm",
//         className
//       )}
//     >
//       {children}
  ...
  return (
    ...
    >
      <div className="h-24 relative flex flex-col items-center overflow-hidden text-center text-xl md:text-3xl ">
        ...
        <div className="overflow-hidden text-center items-center [mask-image:linear-gradient(to_bottom,transparent,white,transparent)]">
          <p className="text-4xl sm:text-[5rem] py-10 font-bold bg-clip-text text-transparent bg-[#323238]">
            {text}
          </p>
          <MemoizedStars />
        </div>
